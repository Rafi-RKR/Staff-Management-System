...
public class DeleteHourlyStaffFrame {
	...
	public void newScreen() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					DeleteHourlyStaffFrame window = new DeleteHourlyStaffFrame(admin);
	 ...
	 */
	public DeleteHourlyStaffFrame(boolean b) {
		this.admin = b;
		initialize();
	}
	...
	private void initialize() {
		...
		btnNewButton_1.setBounds(35, 263, 89, 23);
		...
		btnNewButton_1_1.setBounds(35, 205, 89, 23);
