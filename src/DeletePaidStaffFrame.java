...
public class DeletePaidStaffFrame {
	...
	public void newScreen() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					DeletePaidStaffFrame window = new DeletePaidStaffFrame(admin);
	 ...
	 */
	public DeletePaidStaffFrame(boolean b) {
		this.admin = b;
		initialize();
	}
	...
	private void initialize() {
		...
		btnClear.setBounds(110, 290, 89, 23);
		panel.add(btnClear);
		...
		btnNewButton_1.setBounds(35, 265, 89, 23);
