...
public class SearchHourlyStaffFrame {
	...
	public void newScreen() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					SearchHourlyStaffFrame window = new SearchHourlyStaffFrame(admin);
	 ...
	 */
	public SearchHourlyStaffFrame(boolean b) {
		this.admin = b;
		initialize();
	}
	...
	private void initialize() {
		...
		btnNewButton_1.setBounds(35, 203, 89, 23);
