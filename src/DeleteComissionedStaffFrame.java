...
public class DeleteComissionedStaffFrame {
	...
	public void newScreen() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					DeleteComissionedStaffFrame window = new DeleteComissionedStaffFrame(admin);
	 ...
	 */
	public DeleteComissionedStaffFrame(boolean b) {
		this.admin = b;
		initialize();
	}
	...
	private void initialize() {
		...
		btnClear.setBounds(111, 290, 89, 23);
		panel.add(btnClear);
		...
		btnNewButton_1.setBounds(35, 261, 89, 23);
		...
		btnNewButton_1_1.setBounds(35, 204, 89, 23);
