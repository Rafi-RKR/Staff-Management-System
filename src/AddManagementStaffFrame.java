...
public class AddManagementStaffFrame {
	...
	public void newScreen() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AddManagementStaffFrame window = new AddManagementStaffFrame(admin);
	 ...
	 */
	public AddManagementStaffFrame(boolean b) {
		this.admin = b;
		initialize();
	}
	...
	private void initialize() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				op.add(new Login (userName, password));
